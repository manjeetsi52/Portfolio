export const Study = ({ img, institution, year, course, points = [] }) => {
  return (
    <div className="flex gap-5 tracking-wide ">
      {/* Left: Image / Icon */}
      <div className="flex  flex items-center overflow-hidden ">
        <img
          src={img}
          alt={institution}
          className="size-30 object-contain rounded-full"
        />
      </div>

      {/* Right: Content */}
      <div className="space-y-3 border border-neutral-700 w-200 rounded-2xl overflow-hidden">
